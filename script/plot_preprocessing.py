...
# IDs of 3 rice varieties for boxplot
...
# Q-Q Plots for specified columns
qq_columns = ['RTW', 'SHW', 'SHL', 'TTW', 'rSi_2508', 'rSi_0510']
plot_qqplots(Morph_1, qq_columns)
# # Plot Q-Q plots
# plot_qqplot(Morph_1, 'RTW')
# plot_qqplot(Morph_1, 'SHW')
# plot_qqplot(Morph_1, 'SHL')
# plot_qqplot(Morph_1, 'TTW')
# plot_qqplot(Morph_1, 'rSi_2508')
# plot_qqplot(Morph_1, 'rSi_0510')

# Plot boxplots for 3 rice varieties
